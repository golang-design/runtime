# mainthread [![PkgGoDev](https://pkg.go.dev/badge/golang.design/x/runtime/mainthread)](https://pkg.go.dev/golang.design/x/runtime/mainthread)

schedule functions to run on the main thread

> This package was previously published as `golang.design/x/mainthread`. It now
